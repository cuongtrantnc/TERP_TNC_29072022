...
<asp:Content ID="Content1" ContentPlaceHolderID="TERPContentPlaceHolder" runat="server">
    ...
    <div class="title-padding" style="width: 100%">
        <asp:Label runat="server" ID="frmSupplierEvaluation_lblTitle" Text="Supplier Evaluate" CssClass="h4" Font-Bold="true"></asp:Label>
    </div>
    ...
    <%-- Filter and View  --%>
    <div class="row mt-4 " id="SupplierEvaluationFilter">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_lblCode" Text="Code" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                                    <asp:TextBox runat="server" ID="frmSupplierEvaluation_txtCode" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_lblSupplier" Text="Supplier" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                                    <asp:DropDownList ID="ddSupplier" runat="server" CssClass="form-control select2" Style="width: 100%;">
                                    </asp:DropDownList>
                                </div>
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_lblCategory" Text="Category" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_lblItem" Text="Item" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                                    <asp:DropDownList ID="ddItem" runat="server" CssClass="form-control select2" Style="width: 100%;">
                                    </asp:DropDownList>
                                </div>
                                <div class="filter_item">
                                    <asp:Label ID="frmSupplierEvaluation_lblEffDate" runat="server" Text="Effective Date" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                    ...
                    <asp:GridView runat="server" ID="grSupplierEvaluation" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" ShowHeaderWhenEmpty="True" CssClass="table table-bordered mt-2 grview grview-browse"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <div class="itemTemplate">
                                        <asp:ImageButton runat="server" ID="btnPrintSupplierEvaluation" ImageUrl="~/Images/print2.png" ToolTip="Print" CssClass="itemTemplate-icon" />
                                    </div>
                                </ItemTemplate>
                                <ItemStyle CssClass="itemStyle" />
    ...
    <div class="row mt-4 supplier_form" id="SupplierEvaluationForm">
        <div class="col-md-12">
            <div class="card card-border card-boxshadow">
                <div class="card-body">
                    ...
                    <fieldset class="fieldSet">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_formlblCode" Text="Code" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_validation">
                                    <div class="filter_item">
                                        <asp:Label runat="server" ID="frmSupplierEvaluation_formlblSupplier" Text="Supplier" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_item">
                                    <asp:Label ID="frmSupplierEvaluation_formlblEffDate" runat="server" Text="Effective Date" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="far fa-calendar-alt"></i>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_formlblCategory" Text="Category" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_validation">
                                    <div class="filter_item">
                                        <asp:Label runat="server" ID="frmSupplierEvaluation_formlblItem" Text="Item" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="filter_item">
                                    <asp:Label runat="server" ID="frmSupplierEvaluation_formlblComment" Text="Comment" CssClass="font-weight-bold text-right w-50 mr-3"></asp:Label>
                        ...
                        <fieldset class="fieldSet mt-4">
                            <legend class="fieldSet_legend">
                                <asp:Label runat="server" ID="fieldSet_ViewSupplierEvaluation" Text="Supplier Evaluation View"></asp:Label>
                            </legend>
