$(function () {
    ...
    var areaChartCanvasModal = $('#areaChartModal').get(0).getContext('2d');
    ...
    new Chart(areaChartCanvasModal, {
        type: 'bar',
        data: {
            labels: ["W" + new Date('2013-02-01').getWeek(), "W" + new Date('2013-03-01').getWeek(), "W" + new Date('2013-04-01').getWeek(), "W" + new Date('2013-05-01').getWeek()],
            datasets: [
    ...
    var donutChartCanvasModal = $('#donutChartModal').get(0).getContext('2d');
    var donutData = {
        labels: [
            'Chrome',
            'IE',
            ...
            datasets: [
                {
                    ...
                    data: [
                        ...
                        [new Date('2021-01-01'), new Date('2021-12-01')],
                    ],
                    backgroundColor: '#f56954',
                    borderWidth: 1
                },
    ...
    new Chart(donutChartCanvasModal, {
        type: 'horizontalBar',
        data: {
            labels: ['Line 1', 'Line 2', 'Line 3'],
            datasets: [
